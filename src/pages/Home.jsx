  ...
  return (
    <>
      ...
      <section className="reviews">
        ...
        <p>"Ця платформа значно покращила моє навчання! Дуже зручно та зрозуміло." - Олександр</p>
        <p>"Великий вибір курсів і зручний розклад! Рекомендую всім студентам." - Марія</p>
      </section>
